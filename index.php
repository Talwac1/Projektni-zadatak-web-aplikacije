...
<nav id="meni">
	<ul>
		...
		<li><a href="index.php?menu=5"class="link"> Galerija</a></li>	
			...
			<main>';
				# početna stranica
				if (!isset($_GET['menu']) || $_GET['menu'] == 1) { include("projektni zadatak.php"); }
			...
			<div class="icon">
<a href="https://www.youtube.com/channel/UCtN6iuTgleMj2MNiFTiuXXA?view_as=subscriber" class="fa fa-youtube " target="blank"></a>
<a href="https://www.facebook.com/Talwac-1909042366091813/" class="fa fa-facebook" target="blank"></a>
</div>	
		<footer>
			<center>
				<ul>
				<li><p>Copyright &copy; 2018 Hrvoje Čulina.</p></li>
				<li><a href="https://github.com/Talwac1"target="blank"title="MojGitHub"><img class="githublogo" src="githublogo.png"alt="GitHubLogo"/></a></li>
				</ul>
			</center>
		</footer>
	</body>
